...
#        add_history("search", "youtube")
    ...
    if text == "jarvis open fileexplorer" or "jarvis open explorer":
        p1=multiprocessing.Process(target=talk, args=('Opening fileexplorer', ))
    ...
    if text == "jarvis open prompt":
        p1=multiprocessing.Process(target=talk, args=('Opening commandprompt', ))
    ...
    if text == "jarvis shutdown computer" or "jarvis turn off pc":
    ...
    if text == "jarvis restart computer" or "jarvis restart pc":
